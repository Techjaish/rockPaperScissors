...
class RockPaperScissors extends Component {
  ...
  renderGameWonView = () => {
    ...
    const ganeChoiceObjectLIST = choicesList.filter(
      choice => choice.id === gameChoice,
    )
    const gameChoiceObject = ganeChoiceObjectLIST[0]
  ...
  renderGameDrawView = () => {
    ...
    return (
      <GameResultViewContainer>
        ...
        <PlayAgainButton type="button" onClick={this.onClickGoToGaneView}>
          PLAY AGAIN
        </PlayAgainButton>
      </GameResultViewContainer>
    )
    ...
    return (
      <AppContainer>
        ...
        <PopupContainer>
          <Popup
            modal
            triggers={<TriggerButton type="button">Rules</TriggerButton>}
            closeOnEscape
            window
          >
            {close => (
